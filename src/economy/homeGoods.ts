...
import { BOOKCASE_PRICE } from './pricing';
...
export const HOME_GOODS: readonly HomeGood[] = [
  ...
  { id: 'rug', name: 'Kilim rug', price: 120, blurb: 'Hand-woven, a little faded. For the hallway.', repeatable: false },
  { id: 'lamp', name: 'Lava lamp', price: 90, blurb: 'Orange wax, warms up slowly. Sits on the side table by the TV.', repeatable: false },
  { id: 'poster', name: 'Framed game poster', price: 60, blurb: 'A shop display poster from the nineties, for the hallway.', repeatable: false },
  { id: 'crt', name: 'Portable CRT', price: 300, blurb: 'A 14-inch set for the kitchen: longplays while the kettle boils.', repeatable: false },
];
