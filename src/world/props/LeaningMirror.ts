 ...
 * the room. Collides over the wedge it takes up (nothing reflects; the glass is a tinted sheen like the hall mirror's).
 */
export class LeaningMirror extends THREE.Group implements Furniture {
  ...
  constructor(options: LeaningMirrorOptions = {}) {
    ...
    const wood = matte(options.frameColor ?? 0x3c2f24, 0.5);
